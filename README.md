...
3.  Create a `.env` file in the root directory and add the following environment variable:
    ```
    VITE_API_URL=http://localhost:8080/api<img width="1440" height="830" alt="Screenshot 2025-10-24 at 10 24 16 PM" src="https://github.com/user-attachments/assets/0e5c3cd7-acb5-4dfa-8bbf-cb9be0aeb316" />
